            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    <div class="card border-0 shadow mb-4 ">
                        <form action="{{route('account.updateJob',$job->id)}}" method="POST" id="editJobForm" >
                            @csrf
                            <div class="card-body card-form p-4">
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <select class="form-select" name="jobType" id="jobType">
                                            ...
                                            @foreach ($job_types as $JobType)
                                                <option {{ ($job->jobType_id == $JobType->id) ? 'selected' : '' }} value="{{$JobType->id}}">{{$JobType->name}}</option> 
                                            @endforeach
                                        @endif
                                        </select>
                                    </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea value="{{$job->description}}" class="form-control" name="description" id="description" cols="5" rows="5"
                                        placeholder="Description"></textarea>
                                </div>
                                <div class="mb-4">
                                    <label for="" class="mb-2">Benefits</label>
                                    <textarea value="{{$job->benifits}}" class="form-control" name="benefits" id="benefits" cols="5" rows="5" placeholder="Benefits"></textarea>
                                </div>
                                <div class="mb-4">
                                    <label for="" class="mb-2">Responsibility</label>
                                    <textarea value="{{$job->responsibility}}" class="form-control" name="responsibility" id="responsibility" cols="5" rows="5"
                                        placeholder="Responsibility"></textarea>
                                </div>
                                <div class="mb-4">
                                    <label for="" class="mb-2">Qualifications</label>
                                    <textarea value="{{$job->qualification}}" class="form-control" name="qualifications" id="qualifications" cols="5" rows="5"
                                ...
                                <div class="mb-4">
                                    ...
                                    <input value="{{$job->keyword}}" type="text" placeholder="keywords" id="keywords" name="keywords"
                                        class="form-control">
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-4 col-md-6">
                                        ...
                                        <input value="{{$job->com_location}}" type="text" placeholder="Location" id="com_location" name="com_location"
                                            class="form-control">
                                    </div>
                                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#editJobForm').submit(function(e) {
                ...
                e.preventDefault();
                var data = $('#editJobForm').serializeArray()
                // console.log('hii');
                // console.log(data); 
                $.ajax({
